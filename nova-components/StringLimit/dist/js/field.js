...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-string-limit', __webpack_require__(3));
  Vue.component('detail-string-limit', __webpack_require__(6));
  Vue.component('form-string-limit', __webpack_require__(9));
});
